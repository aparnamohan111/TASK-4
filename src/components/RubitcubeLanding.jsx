...
<section id="home" className="hero">
  <div className="hero-content">
    <div className="hero-text">
      <h1>
        Empowering <span>Innovation</span> Through Intelligence
      </h1>
      <p>
        At Rubitcube, we craft intelligent digital solutions — blending creativity,
        AI, and technology to accelerate your business growth.
      </p>
